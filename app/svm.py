            ...
            try:
                ...
                def cros_val(x, y, classifier, cv):
                    ...
                    for train_index, test_index in cv.split(x, y):
                        # Ensure the classifier has probability=True without duplicating parameters
                        params = classifier.get_params()
                        params['probability'] = True  # Force probability=True
                        clf = SVC(**params)
                        ...
                        y_pred = clf.predict_proba(X_test_fold)  # Predict probabilities for test fold
